...
In most situations, the model parameters of growth models cannot be known beforehand. Instead, they must be estimated from experimental data. For this reason, model fitting is a central part of modeling the growth of populations. The **biogrowth** package can fit growth models from four different types of data:

#COMMENT "it can fit primary growth models" does not really relate to the kind of data. Suggestion: can fit four types of models:
#COMMENT Primary growth models
#COMMENT Both primary... 
...
#COMMENT based on the text above, I expected this example to be on `approach="single"`, is line below correct?  
...
#COMMENT: Is the difference in S3 methods relevant for the end user? 
