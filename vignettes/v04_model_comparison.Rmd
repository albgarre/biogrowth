...
In the case of global fits, the `compare_gorwth_fits()` function has many similarities with respect to fittings using `approach="single"`. We first need to fit (at least) two growth models to a set of experiments:
