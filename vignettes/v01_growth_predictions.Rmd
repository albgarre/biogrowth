...
#COMMENT Is it 6 (7 including check) or 9 arguments here?

The `predict_growth()` function has 9 arguments, as well as the `...` argument to pass additional arguments to the functions used for making the predictions. The prediction is defined by the following 6 arguments:
