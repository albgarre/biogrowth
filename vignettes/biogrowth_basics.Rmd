...
#COMMENT It is obvious, but this package will attract N00B (PhD)students that have limited experience in R
...
my_MCMC_fit <- fit_MCMC_growth(example_dynamic_growth, example_env_conditions, 
                                ...
                                sec_model_names, 
                                niter = 500,
                                updatecov = 10) #COMMENT probably a hacky solution, do we need to look at what causes the low nr of accepted runs?
