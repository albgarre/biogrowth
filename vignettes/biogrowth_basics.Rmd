...
logN (the observed microbial count).
...
* `model_name`: a character vector indicating the primary model. Admisible values are those returned by `primary_model_data`.
...
* `experiment_data` a nested list describing the experimental data and conditions.
...
start <- list(mu_opt = 1.6, temperature_xopt = 30)
...
global_MCMC <- fit_multiple_growth_MCMC(start, multiple_experiments, known, sec_names, 
                                        niter = 100,
                                        lower = c(.8, 29),  # lower limits of the model parameters
                                        upper = c(3, 34))  # upper limits of the model parameters
